...
from generate_space import generate_combinations, generate_table



BLOCK_SIZES_M = [16, 32, 64, 128, 256]
BLOCK_SIZES_N = [16, 32, 64, 128, 256]
BLOCK_SIZES_K = [16, 32, 64, 128, 256, 512]
# GROUP_SIZES = [4, 8]
# NUM_STAGES = [3, 4, 5] 
NUM_WARPS = [4, 8, 16]
...
print("the search space:", len(configs))
# for combination in combinations:
#     # config_item = {}
#     config_dict = {}
#     config_dict['BLOCK_SIZE_M'] = combination[0]
#     config_dict['BLOCK_SIZE_N'] = combination[1]
#     config_dict['BLOCK_SIZE_K'] = combination[2]
#     config_dict['GROUP_SIZE_M'] = 8
#     # config_dict["num_warps"] = combination[3]
#     # config_dict["num_stages"] = 1
#     # print(config_dict)
#     # config_item.append(config_dict)
#     # config_item.append(combination[3])
#     # config_item.append(1)
#     # print(triton.Config(config_dict))
#     # print(triton.Config(config_item))
#     # configs.append(triton.Config(config_item))
#     print(config_dict)
#     configs.append(triton.Config({'BLOCK_SIZE_M': 128, 'BLOCK_SIZE_N': 256, 'BLOCK_SIZE_K': 64, 'GROUP_SIZE_M': 8}, num_stages=2, num_warps=8))
...
def benchmark(M, N, K, provider):
    a = torch.randn((2048, 1024), device='cuda', dtype=torch.float16)
...
print(f"Time spent on auto-tuning: {sum(tuningtime_list)} seconds")
