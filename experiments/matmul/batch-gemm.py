...
@triton.testing.perf_report(
    triton.testing.Benchmark(
        ...
        styles=[('green', '-'), ('blue', '-')],
        ylabel="TFLOPS",  # Label name for the y-axis
        plot_name="batch-4-matmul-performance",  # Name for the plot, used also as a file name for saving the plot.
        args={},
    )
)
...
benchmark.run(show_plots=True, print_data=True, save_path="./test.pdf")